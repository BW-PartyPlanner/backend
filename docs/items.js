//    npx apidoc -i docs/ -o apidocs/   // command to generate docs

//    npx apidoc-markdown2 -p apidocs/ -o README.md -o README.md    have to be in the root folder, generates the readme file
